	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'flyAcross': {
					'0%': { transform: 'translateX(-100px) translateY(0)', left: '-5%' },
					'50%': { transform: 'translateX(55vw) translateY(-20px)' },
					'100%': { transform: 'translateX(110vw) translateY(0)', left: '100%' }
				},
				'bounceFly': {
					'0%': { transform: 'translateX(-100px) translateY(0)', left: '-5%' },
					...
					'100%': { transform: 'translateX(105vw) translateY(0)', left: '100%' }
				},
				'pulse': {
					'0%, 100%': { opacity: '1' },
					'50%': { opacity: '0.7' }
			...
			animation: {
				...
				'bounceFly': 'bounceFly 20s ease-in-out infinite',
