            ...
            <div className="grid md:grid-cols-5">
              ...
              <div className="p-8 md:col-span-3 bg-gray-850/50 backdrop-blur-md">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        name="service"
                        required
                        className="w-full bg-gray-800/60 border border-gray-700 rounded-lg py-3 px-10 text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-transparent appearance-none"
                      >
                        ...
                        <option value="Immigration Consultation">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-medium py-3 rounded-lg shadow-lg hover:shadow-indigo-500/20 transition-all text-sm"
                  >
